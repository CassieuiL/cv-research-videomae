...
OUTPUT_DIR='/root/autodl-tmp/cv-research-videomae/outputs/ucf101_domain_ssv2'
DATA_PATH='/root/autodl-tmp/cv-research-videomae/datasets/ucf101/annotations'
MODEL_PATH='/root/autodl-tmp/cv-research-videomae/pretrained_weights/vit_b_ssv2_800e.pth'
