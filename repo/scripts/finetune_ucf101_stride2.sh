...
# Config: T=16, stride=2, 1-clip inference, 50 epochs
# Expected result: ~85-91% Top-1 (论文报告 91.3%)
# Usage: bash finetune_ucf101_ablation_stride2.sh
# ============================================================
set -e
...
OUTPUT_DIR='/root/autodl-tmp/cv-research-videomae/outputs/ucf101_ablation_stride2'
